...
public class FreshPromotion {
    public static int freshPromotion(String[] shoppingCart, String[][] codeList) {
        ...
        while (codeIndex < codeList.length && cartIndex < shoppingCart.length) {
            if (codeList[codeIndex][0].equals("anything") || codeList[codeIndex][0].equals(shoppingCart[cartIndex])) {
                if (valid(codeList[codeIndex], shoppingCart, cartIndex)) {
                    cartIndex += codeList[codeIndex].length - 1;
                    codeIndex++;
                }
            }
            cartIndex++;
    ...
    private static boolean valid(String[] code, String[] shoppingCart, int cartIndex) {
        for (String s : code) {
            if (cartIndex < shoppingCart.length && (s.equals("anything") || s.equals(shoppingCart[cartIndex]))) {
                cartIndex++;
            } else {
                return false;
            }
    ...
    public static void main(String[] args) {
        String[][] code1 = {{"apple", "apple"}, {"banana", "anything", "banana"}};
        String[] cart1 = {"orange", "apple", "apple", "banana", "orange", "banana"};
        System.out.println(freshPromotion(cart1, code1));
        String[] cart2 = {"banana", "orange", "banana", "apple", "apple"};
        System.out.println(freshPromotion(cart2, code1));
        String[] cart3 = {"apple", "banana", "apple", "banana", "orange", "banana"};
        System.out.println(freshPromotion(cart3, code1));
        String[] cart4 = {"apple", "apple", "apple", "banana"};
        System.out.println(freshPromotion(cart4, code1));
